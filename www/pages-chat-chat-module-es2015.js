...
/* harmony import */ var _firebase_storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @firebase/storage */ "./node_modules/@firebase/storage/dist/index.esm.js");
    ...
    platformId, zone) {
        ...
        () => {
            ...
            if (_firebase_storage__WEBPACK_IMPORTED_MODULE_6__["registerStorage"]) {
                Object(_firebase_storage__WEBPACK_IMPORTED_MODULE_6__["registerStorage"])((/** @type {?} */ (firebase_app__WEBPACK_IMPORTED_MODULE_5___default.a)));
            }
...
let ChatPage = class ChatPage {
    constructor(chatService, router, afs, afStorage) {
    ...
    uploadImage(event) {
        ...
        this.trackSnapshot = this.fileUploadTask.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => {
