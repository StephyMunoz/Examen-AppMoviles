...
const redirectLoggedInToChat = () => Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectLoggedInTo"])(['/chat']);
const routes = [
    Object.assign({ path: '', loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginPageModule) }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(redirectLoggedInToChat)),
    Object.assign({ path: 'chat', loadChildren: () => Promise.all(/*! import() | pages-chat-chat-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-chat-chat-module")]).then(__webpack_require__.bind(null, /*! ./pages/chat/chat.module */ "./src/app/pages/chat/chat.module.ts")).then(m => m.ChatPageModule) }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(redirectUnauthorizedToLogin)),
    {
...
module.exports = __webpack_require__(/*! D:\Documents\EPN\Quinto\App Moviles\Examen-AppMoviles\src\main.ts */"./src/main.ts");
